...
const apikey = "Rt1-gs38pTQwY21mPDB0RZ4W3mh1KAR62aN6vsgHe1dA"
const url = "https://api.eu-gb.speech-to-text.watson.cloud.ibm.com/instances/3fb2bc87-7dae-4aa3-b457-808563ea7f4a"
...
app.post('/postText', (req, res) => {
  ...
  fs.writeFile(`C:/Users/12/Desktop/projetFed/tmp/${uuid()}.txt`, text, function (err) {
    if (err) {
...
app.get('/api/data',(req,res)=>{
  db.query("SELECT * FROM polarity",(err,result)=>{
    if(err){
      console.log(err)
    }
    else{
